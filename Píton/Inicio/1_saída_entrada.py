# Os comentários são escritos após a "#"
# Para rodar uma parte especifica do código, selecione-o e clique "Shift" + Enter.

print("Olá Mundo") #print - Comando de saída

nome = input ("Qual seu nome? ") #input - Comando de entrada - Presupõe o valor como texto (String).

# f - antes das aspas para determinar uma String formatada + {variavel}
print(f"Ah, seu nome é {nome}, muito belo!") #combinação de input com print 
