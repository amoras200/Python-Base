# Material complementar extraído de vídeos do YouTube e outros.
# Cada linha indica o arquivo de origem seguido do link encontrado.
...
# 9_funcoes: https://youtu.be/NJzzyMiq2ro?si=iMYGyAfxmkDuXlB_
# 4_loops_while: https://youtu.be/gZBV7FlHDtg?si=BOexHfmrLVRnCURI
# introdutório: https://youtu.be/oF-nokxQ8qI?si=tsC8k_2LS1g3BB3_

# Procure por plataformas de exercícios de programação como HackerRank, LeetCode, BeeCrownd, Codewars e Exercism.

# roadmap de estudos emthon:https://roadmap.sh/python